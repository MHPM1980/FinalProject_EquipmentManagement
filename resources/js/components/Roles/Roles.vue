        ...
        return{
            ...
            permissions:{
                1:[ "Visualizar equipamentos",
                    ...
                    "Gerir reservas (autorizar, recusar)",
                    "Eliminar reservas",
                    "Gerir utilizadores (criar, editar, eliminar)",
                    "Gerir equipamentos (criar, editar, eliminar)",
                    "Gerir categorias de equipamentos (criar, editar, eliminar)",
                    "Gerir entidades (criar, editar, eliminar)",
                    "Gerir armazéns (criar, editar, eliminar)",
                    "Gerir centros de custo (criar, editar, eliminar)"
                ],
